            ...
            <div className="min-h-screen bg-[#FEF6C9] flex justify-center items-center">
                <div className="p-8 flex-1">
                    <div className="w-80 bg-white rounded-3xl mx-auto overflow-hidden shadow-xl">
                        <div className="relative h-48 bg-[#96C0B7] rounded-bl-4xl">
                        ...
                        <div className="px-10 pt-4 pb-8 bg-white rounded-tr-4xl">
                            ...
                            <form className="mt-12" action="" method="POST">
                                <div className="relative">
                                    ...
                                    <label  className="absolute left-0 -top-3.5 text-gray-600 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm">Электронная почта</label>
                                </div>
                            ...
                            <a href="#" className="mt-4 block text-sm text-center font-medium text-rose-400 hover:underline focus:outline-none focus:ring-2 focus:ring-rose-500">Забыли пароль? </a>
                        </div>
                    </div>
                </div>
            </div>
